      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={t.name}
              className={`reveal stagger-${i + 1} card-hover bg-gray-50 rounded-2xl p-8 shadow-sm relative group`}
            >
              {/* Large decorative quote */}
              <div className="text-6xl text-amber-200 font-serif absolute top-4 left-6 leading-none select-none group-hover:text-amber-300 transition-colors">
                "
              </div>
